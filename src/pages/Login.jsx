        ...
        <div className="min-h-screen pt-32 pb-12 flex items-center justify-center px-4">
            <div className="max-w-md w-full glass-panel p-8 md:p-10 space-y-8 animate-fade-in-up">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Sign in to access your orchard account</p>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-white dark:bg-[#1F2833] text-gray-500">Or continue with email</span>
                    </div>
                </div>
                ...
                <form className="space-y-4" onSubmit={handleEmailLogin}>
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center space-x-2 cursor-pointer group">
                            ...
                            <span className="text-gray-600 dark:text-gray-400 group-hover:text-brand-primary dark:group-hover:text-white transition-colors">Remember me</span>
                        </label>
                        <button type="button" className="text-brand-accent hover:text-brand-accent/80 font-medium transition-colors">
                            Forgot password?
                        </button>
                    </div>
                ...
                <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <button onClick={() => navigate('/signup')} className="text-brand-primary dark:text-white font-bold hover:underline">
                        Create account
                    </button>
                </p>
            </div>
